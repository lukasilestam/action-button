...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-action-buttons', __webpack_require__(3));
  Vue.component('detail-action-buttons', __webpack_require__(6));
  Vue.component('form-action-buttons', __webpack_require__(9));
});
